...
<body class="bg-[#da0037] flex justify-center items-center h-screen">
    <div class="bg-white rounded-lg flex flex-col justify-center items-center w-max p-5 shadow-xl shadow-black/50">
        ...
        <input type="text" class="w-11/12 rounded-lg outline outline-offset-2 outline-slate-500/50 px-1 py-1 mt-3"
            placeholder="Username">
        <input type="password"
            class="w-11/12 rounded-lg outline outline-offset-2 outline-slate-500/50 border-slate-500 px-1 py-1 mt-5"
        ...
        <button class="w-11/12 bg-[#da0037] rounded-full text-white mt-2 mb-2">Login</button>
        <p>you don't have an account? <a href="" class="text-[#da0037] hover:font-bold">Register Here</a></p>
    </div>
</body>
